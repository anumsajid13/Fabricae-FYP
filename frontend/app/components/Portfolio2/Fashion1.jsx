    ...
    <div className="flex justify-center items-center min-h-screen bg-[#efe8e4] p-6">
      <div className="max-w-4xl w-full grid grid-cols-2 gap-8 items-center">
        ...
        <div className="text-left">
          <p className="italic text-gray-600 text-center text-xl">- SUSAN BONES -</p>
          <h1 className="text-6xl font-serif font-bold leading-tight">APPAREL DESIGNER</h1>
          ...
          <p className="italic mt-6 text-gray-600 text-center text-xl">- 2022 -</p>
        </div>
        {/* Right Section */}
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#efe8e4] p-6">
        <div className="max-w-4xl w-full grid grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center">
            ...
            <p className="text-xl mt-4">You can enter a subtitle here if you need it</p>
 ...
 export  const AboutMe2 = () => {
    return (
        ...
        <div className="grid grid-cols-3 gap-4 border border-black p-4 max-w-3xl mx-auto">
          <img src="/aboutme1.jpg" alt="Sketching design" className="w-full h-48 object-cover border" />
          <img src="/aboutme2.jpg" alt="Cutting fabric" className="w-full h-48 object-cover border" />
          <img src="/aboutme3.jpg" alt="Pattern making" className="w-full h-48 object-cover border" />
        </div>
      </div>
    </div>
  ...
  export const MyServices = () => {
    const services = [
      { name: "Mercury", description: "It’s the closest planet to the Sun", image: "/service1.png" },
      { name: "Venus", description: "Venus is the second planet from the Sun", image: "/service2.png" },
      { name: "Mars", description: "Mars is actually a very cold place", image: "/service3.png" },
      { name: "Jupiter", description: "Jupiter is the biggest planet of them all", image: "/service4.png" },
      { name: "Saturn", description: "It’s composed of hydrogen and helium", image: "/service5.png" },
      { name: "Neptune", description: "It’s the farthest planet from the Sun", image: "/service5.png" }
    ];
        ...
        <div className="grid grid-cols-3 gap-8 max-w-5xl w-full text-center">
          {services.map((service, index) => (
            <div key={index} className="flex flex-col items-center">
              <img src={service.image} alt={service.name} className="w-20 h-20 border border-black p-2" />
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#efe8e4] p-6">
        <div className="max-w-4xl w-full grid grid-cols-2 gap-8 items-center border border-black p-6">
          <div className="text-center">
            ...
            <p className="text-xl mt-4">
              It’s the closest planet to the Sun and the smallest one in the Solar System—it’s only a bit larger than our Moon. The planet’s name has nothing to do with the liquid metal, since Mercury was named after the Roman messenger god.
            </p>
          </div>
          <div className="border border-black p-2">
            <img
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#efe8e4] p-6">
        <div className="max-w-4xl w-full border border-black p-6 text-center">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <img src="/research1.jpg" alt="Research process 1" className="w-full h-auto object-cover border" />
            <img src="/research2.jpg" alt="Research process 2" className="w-full h-auto object-cover border" />
          </div>
          ...
          <ul className="text-xl text-left list-disc list-inside mt-4">
            <li>Gathering the resources, which include fabrics, trims, and fastenings, to create concrete, practical aspects for your collection.</li>
            <li>Establishing the concept, which is the visual inspiration for the design process. This will assist you in creating a unique persona for your creative endeavors.</li>
          </ul>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-[#efe8e4] p-6">
        <div className="max-w-4xl w-full grid grid-cols-2 gap-8 items-center border border-black p-6">
          ...
          <div className="text-center">
            <p className="italic text-gray-600 text-xl">- SUSAN BONES -</p>
            <h2 className="text-5xl font-serif font-bold">MY WORK - <span className="italic">Area 1</span></h2>
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-[#efe8e4] p-6">
        <div className="max-w-4xl w-full border border-black p-6">
          <h2 className="text-5xl font-serif font-bold text-center">PROJECT 1: IN DEPTH</h2>
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#efe8e4] p-6">
        <div className="max-w-4xl w-full border border-black p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-8 border border-black p-2">
            <img src="/pro1.jpg" alt="Fashion Design Work 1" className="w-full h-auto object-cover border" />
            <img src="/pro2.jpg" alt="Fashion Design Work 2" className="w-full h-auto object-cover border" />
          </div>
        </div>
      </div>
    );
