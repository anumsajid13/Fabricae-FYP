  ...
  return (
    <div className="h-full w-full rounded-md bg-black relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-1xl mx-auto p-4">
        <h1 className=" mt-10 relative z-10 text-lg md:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 from-neutral-200 to-neutral-600 text-center font-sans font-bold">
          Let's Design Motifs!
        </h1>
        <br></br>
