      ...
      <div className="w-[1510px] bg-[#E7E4D8] shadow-xl p-6">
        <div className="flex gap-6">
          <div className="w-[300px] bg-[#434242] rounded-lg p-4">
            <div className="text-lg font-semibold mb-4 text-[#E7E4D8]">
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-[#434242]">
                            Page {slideNumber}
                          </div>
                          <div className="text-sm text-[#616852]">
          ...
          <div className="flex-1">
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                  <button className="p-2 hover:bg-[#E7E4D8] rounded-lg transition-colors duration-200">
                    <span
                      className="material-symbols-outlined text-[#E7E4D8] hover:text-[#434242] "
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <label
                              ...
                              className="text-sm font-medium text-[#434242]"
                            >
                    ...
                    {openDropdown === "color" && (
                      ...
                      >
                        <div className="space-y-4">
                          {/* Color categories */}
                          <div>
                            <h3 className="text-sm font-medium text-[#434242] mb-2">
                              Brand Colors
                            </h3>
            ...
            <div
              className={`bg-[#434242] rounded-lg h-[540px] p-6 container ${
