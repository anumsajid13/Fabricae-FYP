...
export const useFashionStore = create(
  ...
  elementPositions: {
    ...
    "resume": {
      heading: { x: 50, y: 0, width: 600, height: 100 },
      label1: { x: 0, y: -30, width: 300, height: 50 },
      label4: { x: 50, y: -50, width: 200, height: 50 },
      description1: { x: 0, y: -80, width: 250, height: 50 },
      description2: { x: 10, y: -120, width: 250, height: 100 },
      label2: { x: 0, y: -30, width: 300, height: 50 },
      label5: { x: 50, y: -50, width: 200, height: 50 },
      description3: { x: 0, y: -80, width: 250, height: 50 },
      description4: { x: 10, y: -120, width: 250, height: 100 },
